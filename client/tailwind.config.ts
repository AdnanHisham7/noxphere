  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        // Noxphere
        "orbit-radial":
          "radial-gradient(circle at 50% 40%, rgba(204,255,0,0.14) 0%, rgba(110,139,255,0.08) 38%, transparent 70%)",
        "orbit-core-glow":
          "radial-gradient(circle at center, rgba(204,255,0,0.3) 0%, transparent 65%)",
        "orbit-panel": "linear-gradient(160deg, #1a1a24 0%, #111118 100%)",
        "orbit-cta":
          "linear-gradient(135deg, #e0ff66 0%, #ccff00 60%, #b3e600 100%)",
      },
      boxShadow: {
        ...
        // Noxphere
        "core-glow":
          "0 0 1px rgba(204,255,0,0.4), 0 0 32px rgba(204,255,0,0.22)",
        "ion-glow": "0 0 24px rgba(110,139,255,0.18)",
        "orbit-card":
          "0 1px 0 rgba(255,255,255,0.06) inset, 0 20px 40px -20px rgba(0,0,0,0.6)",
      },
      borderColor: {
