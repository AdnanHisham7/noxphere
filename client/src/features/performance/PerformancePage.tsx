    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Performance is logged against a scheduled session
          </p>
        </div>
        <select
        ...
        {sessionsLoading ? (
          ...
          <EmptyState
            ...
            action={
              <Link
                to="/schedule"
                className="text-volt-400 hover:underline text-sm"
              >
                Go to Schedule →
              </Link>
            }
            ...
            {nonCancelled.map((s) => (
              ...
              >
                <div className="flex items-center gap-2 flex-wrap">
                  <p className="font-display font-bold text-slate-900 dark:text-white uppercase tracking-wide text-sm">
                    {s.teamName ?? "Team"}
                  </p>
                  <Badge
      ...
      <div>
        ...
        {isLoading ? (
          ...
          <EmptyState
            title="No performance logged yet"
            description="Log performance from a scheduled session above."
          />
        ) : (
              ...
              <tbody>
                {records.map((r, i) => (
                  <tr key={r._id} className={i % 2 === 0 ? "" : "bg-white/1"}>
                    ...
                    <td className="px-4 py-3 text-center font-display font-bold text-volt-400">
